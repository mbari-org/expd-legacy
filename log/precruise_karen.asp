...
precruise_karen.asp - Application for submitting precruises

=head1 SYNOPSIS

    http://expd.mbari.org/expd/log/precruise_karen.asp
...
$this_script = 'precruise_karen.asp';
              ...
              <tbody id="cruise_specific_info_section" style="display: none;">
                ...
                <tr id="chief-scientist">
                  ...
                  <td valign="top">
                    ...
                    <a href="person_karen.asp">Add/edit person to list</a>
                  </td>
                </tr>
...
#
# Need to get PersonID numbers for waypoint_karen.asp
#
open_database($dsn);
  ...
  if ( $flag eq 'orderwpts' ) {
    ...
    <tr>
      <td valign="top" colspan="2"> 
        ...
        <a href="waypoint_karen.asp?action=select&piID=<%= $Session->{'piID'}%>&csID=<%= $Session->{'csID'}%>" class="button gray" font:"size=3" letter-spacing:"0.5px" style="width: auto"><strong>
...
<%  } 
    ...
    <td valign="top" colspan="2"> 
    <img src="compassrose_small.jpg" border="0">
    <a href="waypoint_karen.asp?action=select&piID=<%= $Session->{'piID'}%>&csID=<%= $Session->{'csID'}%>" class="button gray" font:"size=3" letter-spacing:"0.5px" style="width: auto" id="saveLocalStorage" onclick="saveStorage()"><strong>Select Waypoints</strong></font></a> 
...
# 
# Description: 
#      Pass chief scientists & PI to waypoints_karen.asp in order to
  ...
  <table border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        <select name="ExpdChiefScientist" size="1">
          <%= $cs_option_list %>
          <a href="person_karen.asp">Add/Edit person list</a>
        </td>
      </tr>
    </table>
