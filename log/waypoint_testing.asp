...
<%
precruise_asp = "precruise_testing.asp"
%>
...
'      Response.Write "<H2>The export feature has been temporarily disabled.  sorry about the inconvienence.</H2>"
   ...
   Sub dephault
      ...
      Else
         ...
         Response.Write ("<form name=thisForm method=get action=waypoint_testing.asp>")
        ...
        Response.Write ("<option value=0>" & "show all waypoints" & "</option>")
         ...
         Else
            ...
            Response.Write ("<tr><td>")     
            'Response.Write ("<a href=waypoint_testing.asp?action=add>Add</a> new waypoints.")

            Response.Write ("<a href=""waypoint_testing.asp?action=add"" class=""button gray"">Add new waypoints</a>&nbsp;&nbsp;")

            Response.Write ("</tr></td>")

            'Response.Write ("<tr><td>")     
            'Response.Write ("<a href=waypoint_testing.asp?action=import>Import</a> waypoints from a file.<br>")
            ...
            'Response.Write ("You may enter your waypoints individually using the <a href=""https://mww.mbari.org/expd/log/waypoint_testing.asp?action=add"">add</a> link.</font>")
            'Response.Write ("</td></tr>")
   ...
   '
   'waypoint_testing.asp?action=select&csID=<id>&piID=<id>
   ...
   Sub view(flag)
      ...
      Else
         ...
         If oViewRS.BOF And oViewRS.EOF Then
            ...
            Waypoint not listed here? <input type="submit" class="button blue" letter-spacing:"0.5px" style="width: auto" value="Add / Edit from master list" onclick="location.href='waypoint_testing.asp'">
      ...
      %>
         ...
         <br><br><hr><br>
            ...
            Response.Write ("<a href=""waypoint.asp"" class=""button gray"" letter-spacing:""0.5px"" style=""width: auto"">Add / Edit from Master List</a>&nbsp;&nbsp;")
       else
               if (Request.QueryString("personID")) then
                  if (Not IsNull(Request.QueryString("orderby"))) then
                     Response.Write ("<a href=waypoint_testing.asp?action=export&personID=" & _
                     ...
                     Response.Write ("&nbsp;&nbsp;<a href=waypoint_testing.asp?action=view&personID=" & _
                                     Request.QueryString("personID") & _
                                     "&orderby=" & Request.QueryString("orderby") & _
                                     "&sortdir=" & Request.QueryString("sortdir") & _
         ...
         if (Not IsNull(Request.QueryString("orderby"))) then
            Response.Write ("<a href=waypoint_testing.asp?action=export&personID=0" & _
                            "&orderby=" & Request.QueryString("orderby") & _
                            "&sortdir=" & Request.QueryString("sortdir") & _
                            " target=_blank>Export</a> waypoints to a text file.")
            Response.Write ("&nbsp;&nbsp;<a href=waypoint_testing.asp?action=view&personID=0" & _
                            "&orderby=" & Request.QueryString("orderby") & _
                            "&sortdir=" & Request.QueryString("sortdir") & _
                            ">Refresh</a> waypoint table <small>(use this after Updating or Deleting)</small>.")
         else
         ...
         End if
            ...
            if (Request.QueryString("personID")) then
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=view&orderby=fn")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=ln")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=wn")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=ve")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=la")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=lo")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=de")
...
'''               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=al&personID=" & Request.QueryString("personID") & ">Altitude</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=he&personID=" & Request.QueryString("personID") & ">Heading</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=cm&personID=" & Request.QueryString("personID") & ">CMG</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=sp&personID=" & Request.QueryString("personID") & ">Speed</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")

               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=cd")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=ed")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=co")
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=fn")
               If (((Request.QueryString("orderby") = "fn") and (Request.QueryString("sortdir") = "asc"))) Then
                  Response.Write ("&sortdir=desc")
               Else
                  Response.Write ("&sortdir=asc")
 ...
 '''              Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=al&personID=0" & ">Altitude</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=he&personID=0" & ">Heading</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=cm&personID=0" & ">CMG</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_testing.asp?action=" & flag & "&orderby=sp&personID=0" & ">Speed</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
            ...
            strURL = "waypoint_testing.asp?action=update&personID=" & oViewRS("waypointOwnerID") & "&waypointName=" & Server.URLEncode(oViewRS("waypointName"))
            Response.Write("<a href=" & strURL & " target=_blank>Edit</a> ")

            strURL = "waypoint_testing.asp?action=delete&personID=" & oViewRS("waypointOwnerID") & "&waypointName=" & Server.URLEncode(oViewRS("waypointName"))
   ...
   ' add
   '
   'waypoint_testing.asp?action=add
   ...
   '
   'waypoint_testing.asp?action=add&addString=<addString>
      ...
      If Request.QueryString("step") = "2" Then
         ...
         If wptConn.Errors.Count > 0 Then
            ...
            Else
               ...
               Response.Write ("<form name=thisForm method=post action=waypoint_testing.asp?action=add&step=2 ")
''               Response.Write ("<form name=thisForm method=post action=waypoint_testing.asp?action=update&step=2" & _
...
''                                    "&WaypointName=" & Server.URLEncode(filteredText(Request.QueryString("wayPointName"))) & " ")
         ...
         Else
            ...
            Response.Write ("<br><br>")
            Response.Write ("<font size=+1><a href=waypoint_testing.asp?action=add&owner=" &_
            ...
            If ((Not Request("Post_personID")="") and (Not Request("Post_WaypointName")="")) Then
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=update&personID=" & _
               ...
               If Session.Contents("ShipName") Then                
                     Response.Write ("<br><br><a href=waypoint_testing.asp?action=select&personID=" & _
                               Request("Post_personID") & "&waypointName=" & _
                               Server.URLEncode(filteredText(Request("Post_WaypointName"))) & _
      ...
      Else
         ...
         Else
           ...
           Response.Write ("<select name=" & Chr(34) & "Post_personID" & Chr(34) & _
            ...
            'Response.Write ("<TR bgcolor=BlanchedAlmond><td colspan=2>")
            'Response.Write ("<a href=waypoint_testing.asp?action=import>Import</a> new waypoints from a file.")
            'Response.Write ("</td></tr>")
   ...
   '
   '   
   'waypoint_testing.asp?action=delete&personID=<personID>
         ...
         wptConn.Execute strSQL, lngRecs, adCmdText
            ...
            Else
              ...
              objMail.TextBody = "Waypoint Management Message" & Chr(13) & Chr(10) & Chr(13) & Chr(10) & _
                              ...
                              Application("BaseURL") & "/waypoint_testing.asp?action=view&personID=" & _
                              ...
                              Application("BaseURL") & "/waypoint_testing.asp?action=add"
               ...
               Response.Write ("<a href=waypoint_testing.asp?action=add")
   ...
   ' update
   '
   'waypoint_testing.asp?action=update&personID=<personID>
   '             &waypointName=<waypointName>
      ...
      If Request.QueryString("step") = "2" Then
         ...
         Else
            ...
            objMail.TextBody = "Waypoint Management Message" & Chr(13) & Chr(10) & Chr(13) & Chr(10) & _
                           ...
                           Application("BaseURL") & "/waypoint_testing.asp?action=update" & _
   ...
   ' export
   '
   'waypoint_testing.asp?action=export&filetype=<txt/xls?/wpt?/log?>
   '             [&personID=<personID>]
   '             [&waypointName=<waypointName>]
