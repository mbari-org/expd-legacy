      ...
      Else
        ...
        Response.Write ("<option value=0>" & "show all waypoints" & "</option>")
         ...
         Else
            ...
            Response.Write ("<a href=""waypoint_karen.asp?action=add"" class=""button gray"">Add new waypoints</a>&nbsp;&nbsp;")
   ...
   Sub view(flag)
      ...
      Else
         ...
         If oViewRS.BOF And oViewRS.EOF Then
            ...
            Waypoint not listed here? <input type="submit" class="button blue" letter-spacing:"0.5px" style="width: auto" value="Add / Edit from master list" onclick="location.href='waypoint_karen.asp'">
       ...
       <%
         Else
            ...
            Response.Write ("")
      %>
         <form method="GET" action="<%= precruise_asp%>" accept-charset="utf-8" id=form1 name=form1>
