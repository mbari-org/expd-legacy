   ...
   <ul style="width: 1200px; color:#408080; line-height: 0.8; font-weight: bold; font-size: 16px" >
    ...
    <li>Timeline for submitting cruise plans:</li>
      <ul style="line-height: 1.0">
         ...
         <br><br>
        <li>To modify an existing cruise plan email requested changes to the <a href="mailto:lisa@mbari.org?subject=Request: Modify an Existing Precruise Plan">logistics coordinator</a>.</li><br><br>
        <!--<li><font color="red">NOTE: To modify an existing cruise plan between <strong>October 13-17, 2022,</strong></font> email requested changes to either <br><a href="mailto:sara@mbari.org?subject=Request: Modify an Existing Precruise Plan">Sara Arguilla</a> or <a href="mailto:ileik@mbari.org?subject=Request: Modify an Existing Precruise Plan">Ian Leik</a>.</li> -->
    <!--<br><br> -->
...
////////////////////////////////  CRUISE PURPOSE AND DIVER REQUEST  /////////////////////////
  ...
  // EMAIL ALIASING FOR NETWORK ACCESS REQUESTED
  if (document.getElementById('netAccessRequested').value == "YES") {
    // Add to cruise purpose text area.
    joinCruisePurpose();
  }

   if (document.getElementById('netAccessRequested').value == "NO") {
    // Add to cruise purpose text area.
    joinCruisePurpose();
  }

   if (document.getElementById('netAccessRequested').value == "UNSURE") {
    // Add to cruise purpose text area.
    joinCruisePurpose();
  }
  ...
  // EMAIL ALIASING FOR TELEPRESENCE REQUESTED
  if (document.getElementById('telepresenceRequested').value == "YES") {
    // Add to cruise purpose text area.
    joinCruisePurpose();
  }

   if (document.getElementById('telepresenceRequested').value == "NO") {
    // Add to cruise purpose text area.
    joinCruisePurpose();
  }
...
////////////////////////////    WINCHES  ////////////////////////////////////////
  ...
  //////////////////////    SPECIAL NET ACCESS     ///////////////////
  ////////////////////////////////////////////////////////////////////
  if (theForm.NetAccessDesc.value == "") {
...
// Update Special Network Request
function updateNetAccessRequest(text) {
  var netAccessR = text;
  joinCruisePurpose();
...
function joinCruisePurpose(){
  ...
  var diverTxt = "\nDiver Requested: ";
  var netAccessTxt = "\nSpecial Network Access Requested: ";
  ...
  if (dc == "NO") {
    ...
    // Network Access Requested checkbox checked?
  netAccess = document.getElementById('netAccessRequested').value;  //Yes, Unsure or No
  // console.log("netAccess = " + netAccess);
  if (netAccess == "YES" || netAccess == "UNSURE") {
    na = netAccessTxt.bold() + netAccess;
  }
  if (netAccess == "NO") { //If no, don't add
  }
  ...
  //console.log("DC2 = " + dc);
  document.getElementById('allCruisePurposeInfo').value = y + " " + z + " " + na + " " + tp;
...
// Add Special Network Access Request Updates
function updateNetAccessRequest(text) {
  netAccessTxt = text;
  if (document.getElementById('netAccessRequested').value == "no-netAccess") {
    document.getElementsByName('netAccess-requested').value = "NO";
  }
  if (document.getElementById('netAccessRequested').value == "yes-netAccess") {
    document.getElementsByName('netAccess-requested').value = "YES";
  }
  if (document.getElementById('netAccessRequested').value == "unsure-netAccess") {
    document.getElementsByName('netAccess-requested').value = "UNSURE";
  }
    ConfigForm();
    joinCruisePurpose();
    joinEquipment();
...
function ConfigForm()
{
  ...
  if (selectedShip == "dpkd")
  {
    ...
    // Add Special Network Requests
    if (document.getElementById("netAccessRequested").value == "none") {
      document.getElementById("NetAccessDesc").style.display = "none";
    }
    else if (document.getElementById("netAccessRequested").value == "NO") {
      document.getElementById("netAccess-section").style.display = "none";
      document.getElementById("netAccess_statement").style.display = "none";
    }
    else if (document.getElementById("netAccessRequested").value == "YES" || document.getElementById("netAccessRequested").value == "UNSURE") {
      document.getElementById("netAccess-section").style.display = "inline";
      document.getElementById("netAccess_statement").style.display = "inline";
      document.getElementById("NetAccessDesc").style.display = "inline";
      updateRequestedEquip();
      updateRequestedPlatforms();
    }
    ...
    <td>
      ...
      <table border="0" cellpadding="5" cellspacing="0">
          ...
          <div class="padding" id="cruise-purpose-section" style="display:none;">
            ...
            <!-- Diving Operations Request Section -->
            <p class="padding">
            ...
            <!-- Special Network Access Request Section -->
              <p class="padding">
              <label id="netAccess_select_label" for="netAccessRequested"><font face="Arial,Helvetica" size="3" color="black"><a name="netAccesslink"></a>
                <strong><br><br><br><br><font class="flash">Is Special Network Access required for this expedition?</font></strong>
                <select style="margin-left:5px" id="netAccessRequested" name="netAccessRequested" value="" onchange='updateNetAccessRequest(this.value)'>
                  <option value="NO" id="no-netAccess">No</option>
                  <option value="YES" id="yes-netAccess">Yes</option>
                  <option value="UNSURE" id="unsure-netAccess">Unsure</option>
                </select>
              </label>
              <!--</div> -->
            <p class="padding" id="DPNetAccessPlanRequired"><font face="Arial,Helvetica" size="-1" color="brown"><strong>NOTE:</strong> Special Network Access may ONLY be requested for R/V <i>David Packard</i> at this time.</font></p>
            <br><br>
            </p>
            ...
            <p class="padding">
              ...
              <label id="telepresence_select_label" for="telepresenceRequested"><font face="Arial,Helvetica" size="3" color="black"><a name="telepresencelink"></a>
                <strong><br><br><font class="flash">Is telepresence required for this expedition?</font></strong>
...
<!--             <br><a id="mbari-nilspin-policy" target="_blank" href="http://www.mbari.org/at-sea/marine-operations-policies/marine-operations-policies-nilspin"><font size=2 color="blue" face="Arial,Helvetica">MBARI NILSPIN policy</a> -->
        ...
        <div id="meal-requests-section" style="display:none;">
          <p class="padding">
             ...
             <font face="Arial,Helvetica" size="2" color=brown>For R/V <i>David Packard</i>, please send any special meal requests (vegetarian, etc.) to the <a href="mailto:mealspc@mbari.org">ship's steward</a>.
             <br><br><br><br></p>
         <!--<hr> -->
        </div>
        ...
        <!-- Section 4.5A -->
        <!-- Declare Special Network Access on R/V David Packard ONLY IF REQUESTED-->
        <div id="netAccess-section" style="display:none;"><hr>
        <p class="padding"><strong><font class="flash" face="Arial,Helvetica" size=5 color="green"><span style='font-size:30px;'>&#8594;</span> Special Network Access Request for R/V David Packard Info</font></strong><font face="Arial,Helvetica" size="2" color=brown> (Required)</font>
          <br><br>
          <font face="Arial,Helvetica" size="2" id="netAccess_statement" color=brown>You indicated above in Section I that Special Network Access will (or may) be needed for this MBARI expedition. <strong><br><br>PLEASE LIST YOUR SPCIEAL NETWORK REQUESTS IN THE TEXT AREA BELOW.</strong>   <br>NOTE: You <strong>MUST</strong> provide a full network access request description to ITD <strong>3 weeks</strong> prior to the cruise start date.</font><br>
          <textarea rows="8" id="NetAccessDesc" name="NetAccessDesc" value="NetAccessDesc" cols="160" placeholder="Example: I need network access to the Atlas server while at sea...." wrap></textarea><br><br>
...
%>
         ...
         // SAVE PREVIOUSLY ANSWERED RESPONSES FOR STORAGE AND RECALL AFTER WAYPOINT VISIT TO ALLOW EMAIL ALIASING.
          function saveStorage() {
            ...
            //SPECIAL NET ACCESS - Never null.
            var netAccessFieldStorage = document.getElementById('netAccess-requested').value;
            //console.log("NetAccessFieldStorage = " + netAccessFieldStorage);
            localStorage.setItem('netAccessStorage', JSON.stringify(netAccessFieldStorage));
  ...
  if ( $flag eq 'orderwpts' ) {
    ...
    <tr>
      <td valign="top" colspan="2">
       ...
       var storedNetAccessField = localStorage.getItem('netAccessStorage');
       storedNetAccessField = storedNetAccessField.replace(/^"(.+)"$/,'$1');
       document.getElementById('storedNetAccessField').value = storedNetAccessField;
       //console.log("NET ACCESS STORAGE = " + storedNetAccessField);
       ...
       //console.log("PERMITS STORAGE = " + storedPermitsField);
        ...
        <input type="hidden"style="width: auto" letter-spacing:"0.5px" name="netAccess-requested" id="netAccess-requested" onchange="Field_Validator(this)" value="<%=GetFormValue('storedNetAccessField')%>"/>
        ...
        document.getElementById('netAccess-requested').value = storedNetAccessField;
        //console.log("NET ACCESS STORAGE = " + document.getElementById('netAccess-requested').value);
...
<%  }
      ...
      <!-- EMAIL ALIASING - A BIT CLUGEY BUT WORKS - DISPLAYS AT TOP OF STEP 2 PAGE WHEN NOT HIDDEN -->
          ...
          <input type="hidden" style="width: auto" letter-spacing:"0.5px" name="netAccess-requested" id="netAccess-requested" value="<%=GetFormValue('netAccessRequested')%>">
...
sub procWaypoints {
  ...
  foreach my $f ( @wpts ) {
    ...
    next if ( $f eq 'netAccess-requested' );      
...
#
  ...
  #use warnings;
    ...
    # Special Network Requested Alias
    my $netAccess_email = '';
    $netAccess_email = "ishelp\@mbari.org" if GetFormValue('netAccess-requested') eq "YES" || GetFormValue('netAccess-requested') eq "UNSURE";

    # Telepresence Requested Alias
    my $telepresence_email = '';
    $telepresence_email = "telepresencepc\@listserver.mbari.org" if GetFormValue('telepresence-requested') eq "YES";
    ...
    $smtp->to( $Session->{'logistics_email'}, $submitter_email, $diverpc_email, $netAccess_email, $telepresence_email, $waveglider_email, $ctd_email, $isotope_email, $winch_email, $itar_email, $foreignNational_email, $specialOps_email, $permit_email);
    $smtp->data();
    ...
    $smtp->datasend("Cc: $submitter_email, $diverpc_email, $netAccess_email, $telepresence_email, $waveglider_email, $ctd_email, $isotope_email, $winch_email, $itar_email, $foreignNational_email, $specialOps_email, $permit_email\n" );
...
#
    ...
    # Special Network Access Requested Alias
    my $netAccess_email = '';
    $netAccess_email = "ishelp\@mbari.org" if GetFormValue('netAccess-requested') eq "YES" || GetFormValue('netAccess-requested') eq "UNSURE";   
    ...
    if ($message) {
      ...
      $netAccess_email = "ishelp\@mbari.org";
      $telepresence_email = "telepresencepc\@listserver.mbari.org";
