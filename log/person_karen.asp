...
<form method="get" action="person_karen.asp">
...
<a href="person_karen.asp?add=new">click here to add a person to the list</a></b>
<p>
...
<p><a href="person_karen.asp">Return to Person List</a></p>
...
$Conn->Close;
%>
<a href="person_karen.asp">Return to person list</a>
<%
