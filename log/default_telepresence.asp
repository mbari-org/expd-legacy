...
default_telepresence.asp - Default Active Server Page for Expedition Log

=head1 SYNOPSIS

    http://expd.mbari.org/expd/log/default_telepresence.asp
...
if ( GetFormValue('debug') ) {
	beta_intro();
	#$Response->Write("$Application->{'AppDir'}/postcruise_telepresence.asp");
}
elsif ( GetFormValue('goto') =~ /Precruise/i ) {
	process_beta();
	$Response->Redirect("$Application->{'AppDir'}/precruise_telepresence.asp");
}
elsif ( GetFormValue('goto') =~ /Postcruise/i ) {
	process_beta();
	my $url = "$Application->{'AppDir'}/postcruise_telepresence.asp";
	...
	<A href="<%=$Application->{'AppDir'}%>/postcruise_telepresence.asp?step=1&search=advanced&logistics_email=<%=$Session->{'logistics_email'}%>">Search postcruise</a>
	<%
	##$Response->Redirect("$Application->{'AppDir'}/postcruise_telepresence.asp");
}
else {
	release_intro();
}
...
<form method="GET" action="default_telepresence.asp">
 ...
 <td valign="top"><h2 align="center">Expedition Database Administrative Page</h2>
    <h2 align="center">Release 1.2</h2>
      ...
      <table border="3" cellpadding="5" cellspacing="0" height="267">
        <tr>
          <td valign="top" align="left"><strong><a href="postcruise_telepresence.asp">Search Expeditions </a></strong></td>
        ...
        <tr>
          <td valign="top" align="left"><a href="precruise_telepresence.asp"><strong>Precruise entry</strong></a></td>
        ...
        <tr>
          <td valign="top" align="left"><strong><a href="register_telepresence.asp">Registration request</a></strong></td>
          <td valign="top" align="left">Request permission to edit database directly as a power
          user. </td>
        </tr>
        <tr>
          <td valign="top" align="left"><strong><a href="person_telepresence.asp">Person edit</a></strong></td>
          <td valign="top" align="left">Add person as Chief Scientist or PI to database (restricted
          to power users).</td>
        </tr>
        <tr>
          <td valign="top" align="left"><strong><a href="region_telepresence.asp">Region edit</a></strong></td>
      ...
      expedition log site has 2 user modes: </strong><ul>
        ...
        <li><strong>Registered user:</strong> All Postcruise web form entries are directly entered
          into the database. <a href="register_telepresence.asp">Request permission to edit database directly</a>.
          </font></li>
      </ul>
