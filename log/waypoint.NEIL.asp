   ...
   Sub view(flag)
      ...
      Else
         ...
         If oViewRS.BOF And oViewRS.EOF Then
            ...
            <hr>
	    Waypoint not listed here? <a href="waypoint.asp">Select/Add/Edit from master list</a> 
		...
		%>
			...
			<br>Waypoint not listed here? <a href="waypoint.asp">Select/Add/Edit from master list</a> (Check 'Precruise entry')	          	            
			<%
	    else
	            if (Request.QueryString("personID")) then
...
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
 ...
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
			...
			<input type="submit" name="continue" value="Continue with PreCruise"> 
			Waypoint not listed here? <a href="waypoint.asp">Select/Add/Edit from master list</a> (Check 'Precruise entry')
         ...
         Else
            ...
            If Not (oAddRS.BOF and oAddRS.EOF) then
               Do While Not oAddRS.EOF
                  Response.Write("<option value=" & Chr(34) & oAddRS("personID") & _
                                 Chr(34) & ">" & oAddRS("ownerName") & "</option>")
                  oAddRS.MoveNext
               Loop  
            End If
            oAddRS.Close
      ...
      Else
         ...
         If Not (oDeleteRS.BOF and oDeleteRS.EOF) then
            ...
            Else
               ...
               objMail.Body = "Waypoint Management Message" & Chr(13) & Chr(10) & Chr(13) & Chr(10) & _
   ...
   Sub export
      ...
      Else
         ...
         Else
            ...
            strNewLocation = "http://mww.mbari.org/expddata/" + document.theForm.fileName.value;
