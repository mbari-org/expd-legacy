...
<!-- 
File: waypoint_telepresence.asp
Author: Dan Wilkin 
        Mike McCann (added links & connections to precruise_telepresence.asp)
Date: 4/20/2000
...
<!--#include file=z2null_telepresence.inc -->
<!--#include file=filteredtext_telepresence.inc -->
<!--#include file=wpt_db_util_telepresence.inc -->
<%
precruise_asp = "precruise_telepresence.asp"
%>
...
'      Response.Write "<H2>The export feature has been temporarily disabled.  sorry about the inconvienence.</H2>"
   ...
   Sub dephault
      ...
      %> <!--#include file=wpt-hdr_telepresence.inc --> <%
      ...
      Else
         ...
         Response.Write ("<form name=thisForm method=get action=waypoint_telepresence.asp>")
        ...
        Response.Write ("<option value=0>" & "show all waypoints" & "</option>")
         ...
         If Session.Contents("ShipName") Then
            Response.Write ("<input type=radio class=""input radio"" name=action value=view>Edit/delete</input>&nbsp;&nbsp;&nbsp;&nbsp;")
            Response.Write ("<input type=radio class=""input radio"" name=action value=select checked>Precruise entry</input>")
         Else
            Response.Write ("<input type=radio class=""input radio"" name=action value=view checked>Edit/delete</input>&nbsp;&nbsp;&nbsp;&nbsp;")
            Response.Write ("<input type=radio class=""input radio"" name=action value=select>Precruise entry</input>")
         End If
         ...
         Else
            ...
            Response.Write ("<input type=submit class=""button blue"" style=""width: auto"" value=""View the waypoints"">&nbsp;&nbsp;&nbsp;&nbsp;")
            ...
            Response.Write ("<tr><td>")     
            'Response.Write ("<a href=waypoint_telepresence.asp?action=add>Add</a> new waypoints.")

            Response.Write ("<a href=""waypoint_telepresence.asp?action=add"" class=""button gray"">Add new waypoints</a>&nbsp;&nbsp;")

            Response.Write ("</tr></td>")

            'Response.Write ("<tr><td>")     
            'Response.Write ("<a href=waypoint_telepresence.asp?action=import>Import</a> waypoints from a file.<br>")
            ...
            'Response.Write ("You may enter your waypoints individually using the <a href=""https://mww.mbari.org/expd/log/waypoint_telepresence.asp?action=add"">add</a> link.</font>")
            'Response.Write ("</td></tr>")
      ...
      %> <!--#include file=wpt-ftr_telepresence.inc --> <%
   ...
   '
   'waypoint_telepresence.asp?action=select&csID=<id>&piID=<id>
   ...
   Sub view(flag)
      ...
      Else
         ...
         If oViewRS.BOF And oViewRS.EOF Then
            ...
            Waypoint not listed here? <input type="submit" class="button blue" letter-spacing:"0.5px" style="width: auto" value="Add / Edit from master list" onclick="location.href='waypoint_telepresence.asp'">
      ...
      %>
         ...
         <br><b><font face="helvetica,Ariel" size="3">Select Waypoints to visit and press the Continue button ----> 
         <input type="hidden" name="step" value="orderwpts">
         <input type="submit" class="button blue" style="width: auto" letter-spacing:"0.5px" name="continue" onclick="loadStorage()" value="Continue with PreCruise"></input>    

         <script Language="JavaScript">
          function loadStorage() {
            //console.log("Entered loadStorage.");
         ...
         <br><br><hr><br>
            ...
            Waypoint not listed here?<br><br> <%
            Response.Write ("<a href=""waypoint_telepresence.asp"" class=""button gray"" letter-spacing:""0.5px"" style=""width: auto"">Add / Edit from Master List</a>&nbsp;&nbsp;")
       else
               if (Request.QueryString("personID")) then
                  if (Not IsNull(Request.QueryString("orderby"))) then
                     Response.Write ("<a href=waypoint_telepresence.asp?action=export&personID=" & _
                     ...
                     Response.Write ("&nbsp;&nbsp;<a href=waypoint_telepresence.asp?action=view&personID=" & _
                                     Request.QueryString("personID") & _
                                     "&orderby=" & Request.QueryString("orderby") & _
                                     "&sortdir=" & Request.QueryString("sortdir") & _
         ...
         if (Not IsNull(Request.QueryString("orderby"))) then
            Response.Write ("<a href=waypoint_telepresence.asp?action=export&personID=0" & _
                            "&orderby=" & Request.QueryString("orderby") & _
                            "&sortdir=" & Request.QueryString("sortdir") & _
                            " target=_blank>Export</a> waypoints to a text file.")
            Response.Write ("&nbsp;&nbsp;<a href=waypoint_telepresence.asp?action=view&personID=0" & _
                            "&orderby=" & Request.QueryString("orderby") & _
                            "&sortdir=" & Request.QueryString("sortdir") & _
                            ">Refresh</a> waypoint table <small>(use this after Updating or Deleting)</small>.")
         else
         ...
         End if
            ...
            if (Request.QueryString("personID")) then
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=view&orderby=fn")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=ln")
               ...
               Response.Write ("<a href=wwaypoint_telepresence.asp?action=" & flag & "&orderby=wn")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=ve")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=la")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=lo")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=de")
...
'''               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=al&personID=" & Request.QueryString("personID") & ">Altitude</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=he&personID=" & Request.QueryString("personID") & ">Heading</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=cm&personID=" & Request.QueryString("personID") & ">CMG</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")
'''               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=sp&personID=" & Request.QueryString("personID") & ">Speed</a></TH>")
'''               Response.Write ("<TH bgcolor=LightSkyBlue>")

               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=cd")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=ed")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=co")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=fn")
               If (((Request.QueryString("orderby") = "fn") and (Request.QueryString("sortdir") = "asc"))) Then
                  Response.Write ("&sortdir=desc")
               Else
                  Response.Write ("&sortdir=asc")
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=wn")
               If (((Request.QueryString("orderby") = "wn") and (Request.QueryString("sortdir") = "asc"))) Then
                  Response.Write ("&sortdir=desc")
               Else
                  Response.Write ("&sortdir=asc")
 ...
 '''              Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=al&personID=0" & ">Altitude</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=he&personID=0" & ">Heading</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=cm&personID=0" & ">CMG</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
 '''              Response.Write ("<a href=waypoint_telepresence.asp?action=" & flag & "&orderby=sp&personID=0" & ">Speed</a></TH>")
 '''              Response.Write ("<TH bgcolor=LightSkyBlue>")
            ...
            strURL = "waypoint_telepresence.asp?action=update&personID=" & oViewRS("waypointOwnerID") & "&waypointName=" & Server.URLEncode(oViewRS("waypointName"))
            Response.Write("<a href=" & strURL & " target=_blank>Edit</a> ")

            strURL = "waypoint_telepresence.asp?action=delete&personID=" & oViewRS("waypointOwnerID") & "&waypointName=" & Server.URLEncode(oViewRS("waypointName"))
               ...
               For Each oField In oViewRS.Fields
                  ...
                  %>
                     ...
                     If IsNull (oField) Then
                        Response.Write "&nbsp;"
                     Else
                        'note: reformatNumber is in filteredText_telepresence.inc
         ...
         <br><b><font face="helvetica,Ariel" size="3">Select Waypoints to visit and press the Continue button ----> 
         <input type="submit" class="button blue" style="width: auto" letter-spacing:"0.5px" name="continue" value="Continue with PreCruise"></input>
         <br><hr><br>
   ...
   ' add
   '
   'waypoint_telepresence.asp?action=add
   ...
   '
   'waypoint_telepresence.asp?action=add&addString=<addString>
      ...
      If Request.QueryString("step") = "2" Then
         ...
         If wptConn.Errors.Count > 0 Then
            ...
            Else
               ...
               Response.Write ("<form name=thisForm method=post action=waypoint_telepresence.asp?action=add&step=2 ")
''               Response.Write ("<form name=thisForm method=post action=waypoint_telepresence.asp?action=update&step=2" & _
...
''                                    "&WaypointName=" & Server.URLEncode(filteredText(Request.QueryString("wayPointName"))) & " ")
              ...
              'Response.Write ("</TD>")
               ...
               Response.Write ("<input type=""submit"" class=""button gray"" style=""width: auto"" value=""Add"" id=""submit1"" name=""submit1"">&nbsp;&nbsp;")

               Response.Write ("<input type=""reset"" class=""button gray"" style=""width: auto"" value=""Reset"" id=""reset1"" name=""reset1""><br>")
               Response.Write ("</td></tr>")
         ...
         Else
            ...
            Response.Write ("<br><br>")
            Response.Write ("<font size=+1><a href=waypoint_telepresence.asp?action=add&owner=" &_
            ...
            If ((Not Request("Post_personID")="") and (Not Request("Post_WaypointName")="")) Then
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=update&personID=" & _
               ...
               If Session.Contents("ShipName") Then                
                     Response.Write ("<br><br><a href=waypoint_telepresence.asp?action=select&personID=" & _
                               Request("Post_personID") & "&waypointName=" & _
                               Server.URLEncode(filteredText(Request("Post_WaypointName"))) & _
      ...
      Else
         ...
         Else
           ...
           Response.Write ("<select name=" & Chr(34) & "Post_personID" & Chr(34) & _
            ...
            'Response.Write ("<TR bgcolor=BlanchedAlmond><td colspan=2>")
            'Response.Write ("<a href=waypoint_telepresence.asp?action=import>Import</a> new waypoints from a file.")
            'Response.Write ("</td></tr>")
   ...
   '
   '   
   'waypoint_telepresence.asp?action=delete&personID=<personID>
         ...
         wptConn.Execute strSQL, lngRecs, adCmdText
            ...
            Else
              ...
              objMail.TextBody = "Waypoint Management Message" & Chr(13) & Chr(10) & Chr(13) & Chr(10) & _
                              ...
                              Application("BaseURL") & "/waypoint_telepresence.asp?action=view&personID=" & _
                              ...
                              Application("BaseURL") & "/waypoint_telepresence.asp?action=add"
               ...
               Response.Write ("<a href=waypoint_telepresence.asp?action=add")
   ...
   ' update
   '
   'waypoint_telepresence.asp?action=update&personID=<personID>
   '             &waypointName=<waypointName>
      ...
      If Request.QueryString("step") = "2" Then
         ...
         Else
            ...
            objMail.TextBody = "Waypoint Management Message" & Chr(13) & Chr(10) & Chr(13) & Chr(10) & _
                           ...
                           Application("BaseURL") & "/waypoint_telepresence.asp?action=update" & _
   ...
   Sub import
      ...
      <FORM ACTION="fileup/UploadReceive_telepresence.asp" METHOD="POST" ENCTYPE="multipart/form-data"
   ...
   ' export
   '
   'waypoint_telepresence.asp?action=export&filetype=<txt/xls?/wpt?/log?>
   '             [&personID=<personID>]
   '             [&waypointName=<waypointName>]
   ...
   Sub writeFormField (strFieldName, strValue)
      ...
      Response.Write ("</TD>")
      Response.Write ("<TD>")
      Response.Write ("<INPUT CLASS=""input textarea"" NAME=Post_" & strFieldName)
