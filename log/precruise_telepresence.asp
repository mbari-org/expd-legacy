...
<!--#include file="precruise_hdr_telepresence.inc"-->
...
$this_script = 'precruise_telepresence.asp';
...
<table>
  <tr>
   ...
   <ul style="width: 1200px; color:#408080; line-height: 0.8; font-weight: bold; font-size: 16px" >
    ...
    <br>
    <li><a target="_blank" href="http://mww.mbari.org/dmo/">MBARI <font color="red">COVID-19</font> shipboard plans and precruise questionnaire</a> link.</li><br><br>
    ...
    <br>
    <li><a target="_blank" href="http://www.mbari.org/at-sea/cruise-planning/">DMO cruise planning</a> link.</li>
    <br>
...
function ShipSelect(select)
{
  ...
  if (select.options[select.selectedIndex].value == "wfly") {
    ...
    // Show alert only once.
    if (!sessionStorage.returning_wfly_pre) {
    // SWEETALERT
    swal({
      html:
        '<br> ' +
      ...
      sessionStorage.returning_wfly_pre = true; // set returning
    } // End of sessionStorage.returning if    
    return (true);
  } // End of if
...
function ConfigForm()
{
  ...
  if (selectedShip == "wfly")
  {
    ...
    document.getElementById("WFTelepresencePlanRequired").style.display = "inline";
  ...
  else if (selectedShip == "rcsn")
  {
    ...
    document.getElementById("ParagonDivePlanRequired").style.display = "none";  
    document.getElementById("WFTelepresencePlanRequired").style.display = "none";
    ...
    <td> 
      ...
      <table border="0" cellpadding="5" cellspacing="0"> 
              ...
              <tbody id="cruise_specific_info_section" style="display: none;">
                ...
                <tr id="chief-scientist">
                  ...
                  <td valign="top">
                    ...
                    <a href="person_telepresence.asp">Add/edit person to list</a>
                  </td>
                </tr>
          ...
          <div class="padding" id="cruise-purpose-section" style="display:none;">
            ...
            <textarea class="textfield" input="text" rows="10" id="Purpose" name="Purpose" value="" cols="160" placeholder="MAXIMUM Entry Length: 8000 character limit." maxlength="8000" onKeyDown="textCounter(this.form.Purpose,this.form.countDisplay);" onKeyUp="textCounter(this.form.Purpose,this.form.countDisplay);" wrap></textarea> 
            <br>  
            ...
            <p class="padding">
              ...
              <label id="telepresence_select_label" for="telepresenceRequested"><font face="Arial,Helvetica" size="3" color="black"><a name="telepresencelink"></a>
                <strong><br><br><br><br><font class="flash">Is telepresence required for this expedition?</font></strong>
              ...
              <!--</div> -->
            <p class="padding" id="WFTelepresencePlanRequired"><font face="Arial,Helvetica" size="-1" color="brown"><strong>NOTE:</strong> Telepresence may ONLY be requested for R/V <i>Western Flyer</i> and R/V <i>Rachel Carson</i>.</font><br><br></p>
            <p class="padding" id="RCTelepresencePlanRequired"><font face="Arial,Helvetica" size="-1" color="brown"><strong>NOTE:</strong> Telepresence may ONLY be requested for R/V <i>Western Flyer</i> and R/V <i>Rachel Carson</i>.</font>
            <br><br>
            </p>
...
(MAXIMUM Entry Length: 8000 character limit)." maxlength="8000" onclick='checkEquipOther()' onKeyDown="textCounter1(this.form.EquipmentDesc,this.form.countDisplay1)" onKeyUp="textCounter1(this.form.EquipmentDesc,this.form.countDisplay1)" wrap></textarea><br>
          ...
          <fieldset class="WinchSelected" id="WinchSelected" name="WinchSelected" value="test">
            ...
            <label id="flyer-dynacon-winch_label" for="flyer-dynacon-winch" face="Arial,Helvetica" size="-1" color="black"><strong><i>Flyer</i> Dynacon</strong>
              <select style="margin-left:5px" id="flyer-dynacon-winch" name="winchSelect[]" value="FLYER_DYNACON_WINCH" onchange='updateRequestedWinch(this.value)'>
                <option value=" "></option>
        ...
        <p class="padding"><strong><font class="flash" face="Arial,Helvetica" size=5 color="green"><span style='font-size:30px;'>&#8594;</span> Telepresence Participants and Media Broadcast Info</font></strong><font face="Arial,Helvetica" size="2" color=brown> (Required)</font>
          <br><br>
          <font face="Arial,Helvetica" size="2" id="telepresence_participants_statement" color=brown>You indicated above in Section I that Telepresence will be needed for this MBARI expedition. <strong><br><br>PLEASE LIST ALL INDIVIDUALS, THEIR RESEARCH AFFILIATIONS, EMAIL AND PHONE NUMBER(S) (including those from MBARI) THAT WILL BE PARTICIPATING ONSHORE IN THE TEXT AREA BELOW.</strong>   <br>NOTE: You <strong>MUST</strong> provide a completed list of onshore participant names and all information at least <strong>3 weeks</strong> prior to the cruise start date.</font><br>          
          <textarea rows="8" id="TelepresenceParticipantsDesc" name="TelepresenceParticipantsDesc" value="TelepresenceParticipantsDesc" cols="160" placeholder="Example: Dr. Albert Einstein, CalTech, aEinstein@caltech.edu, (626)-123-4567" wrap></textarea><br><br>
...
#
# Need to get PersonID numbers for waypoint_telepresence.asp
#
open_database($dsn);
  ...
  if ( $flag eq 'orderwpts' ) {
    ...
    <tr>
      <td valign="top" colspan="2"> 
        ...
        <a href="waypoint_telepresence.asp?action=select&piID=<%= $Session->{'piID'}%>&csID=<%= $Session->{'csID'}%>" class="button gray" font:"size=3" letter-spacing:"0.5px" style="width: auto"><strong>
...
<%  } 
    ...
    <td valign="top" colspan="2"> 
    <img src="compassrose_small.jpg" border="0">
    <a href="waypoint_telepresence.asp?action=select&piID=<%= $Session->{'piID'}%>&csID=<%= $Session->{'csID'}%>" class="button gray" font:"size=3" letter-spacing:"0.5px" style="width: auto" id="saveLocalStorage" onclick="saveStorage()"><strong>Select Waypoints</strong></font></a> 
...
# 
# Description: 
#      Pass chief scientists & PI to waypoints_telepresence.asp in order to
...
#
  ...
  #use warnings;
    ...
    $telepresence_email = "telepresence\@mbari.org" if GetFormValue('telepresence-requested') eq "YES";    
    ...
    $smtp->to( $Session->{'logistics_email'}, $submitter_email, $diverpc_email, $telepresence_email, $waveglider_email, $ctd_email, $isotope_email, $winch_email, $itar_email, $foreignNational_email, $specialOps_email, $permit_email);        
    $smtp->data();    
    ...
    $smtp->datasend("Cc: $submitter_email, $diverpc_email, $telepresence_email, $waveglider_email, $ctd_email, $isotope_email, $winch_email, $itar_email, $foreignNational_email, $specialOps_email, $permit_email\n" );
...
#
    ...
    if ($message) {
      ...
      $telepresence_email = "telepresence\@mbari.org";
  ...
  <table border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        <select name="ExpdChiefScientist" size="1">
          <%= $cs_option_list %>
          <a href="person_telepresence.asp">Add/Edit person list</a>
        </td>
      </tr>
    </table>
