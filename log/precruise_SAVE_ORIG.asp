   ...
   <ul style="width: 1200px; color:#408080; line-height: 0.8; font-weight: bold; font-size: 16px" >
    ...
    <li>Timeline for submitting cruise plans:</li>
      <ul style="line-height: 1.0">
         ...
         <br><br>
        <li>To modify an existing cruise plan email requested changes to the <a href="mailto:mschultz@mbari.org?subject=Request: Modify an Existing Precruise Plan">logistics coordinator</a>.</li><br><br>
        <!--<li><font color="red">NOTE: To modify an existing cruise plan between <strong>October 13-17, 2022,</strong></font> email requested changes to either <br><a href="mailto:lisa@mbari.org?subject=Request: Modify an Existing Precruise Plan">Lisa Emanuelson</a> or <a href="mailto:mschultz@mbari.org?subject=Request: Modify an Existing Precruise Plan">Matt Schultz</a>.</li> -->
    <!--<br><br> -->
...
#
  ...
  #use warnings;
    ...
    my $diverpc_email = '';
    $diverpc_email = "divingpc\@listserver.mbari.org" if GetFormValue('diver-requested') eq "YES";
    ...
    my $waveglider_email = '';
    $waveglider_email = "waveglider\@listserver.mbari.org" if GetFormValue('asv-check') eq "YES";

    # CTD Requested Alias
    my $ctd_email = '';
    $ctd_email = "ctdpc\@listserver.mbari.org" if GetFormValue('ctd-check') eq "YES";

    # Isotope and or HazMat Declared Alias
    my $isotope_email = '';
    $isotope_email = "isotopepc\@listserver.mbari.org" if GetFormValue('hazIso-check') eq "YES";

    # Winch Requested Alias
    my $winch_email = '';
    $winch_email  = "winchpc\@listserver.mbari.org" if GetFormValue('winch-check') eq "YES";

    # ITAR Declared Alias
    my $itar_email = '';
    $itar_email  = "itarpc\@listserver.mbari.org" if GetFormValue('itar-check') eq "YES";

    # Foreign Nationals Declared Alias
    my $foreignNational_email = '';
    $foreignNational_email = "foreignpc\@listserver.mbari.org" if GetFormValue('foreignNational-check') eq "YES";

    # Planned Track Description Alias
    my $specialops_email = '';
    $specialOps_email = "specialopspc\@listserver.mbari.org" if GetFormValue('specialOps-check') eq "YES";

    # MBNMS Permit Declaration Alias
    my $permit_email = '';
    my $permit_email = "permitpc\@listserver.mbari.org" if GetFormValue('permits-check') eq "YES";

    # Special Meal Requests Alias
    my $mealRequest_email = '';
    #$mealRequest_email = ('mealspc') . "\@listserver.mbari.org";
...
#
    ...
    $smtp->to( GetFormValue('pre_email') . "\@listserver.mbari.org" );        # recipient's address
    ...
    my $permit_email = '';
    $permit_email = "permitpc\@listserver.mbari.org" if GetFormValue('permits-check') eq "YES";
    ...
    if ($message) {
      $diverpc_email = "divingpc\@listserver.mbari.org";
      $telepresence_email = "telepresencepc\@listserver.mbari.org";
      $waveglider_email = "waveglider\@listserver.mbari.org";
      $ctd_email = "ctdpc\@listserver.mbari.org";
      $isotope_email = "isotopepc\@listserver.mbari.org";
      $winch_email  = "winchpc\@listserver.mbari.org";
      $itar_email  = "itarpc\@listserver.mbari.org";
      $foreignNational_email = "foreignpc\@listserver.mbari.org";
      $specialOps_email = "specialopspc\@listserver.mbari.org";
    }
    ...
    ################################
    $smtp->datasend("Message-ID: <" . time() . "@typhoon.shore.mbari.org>\n");
    $smtp->datasend("To: " . GetFormValue('pre_email') . "\@listserver.mbari.org\n");
